...
import to.garazuj.message.request.LoginForm;
import to.garazuj.message.request.SignUpForm;
import to.garazuj.message.response.JwtResponse;
...
import to.garazuj.security.jwt.JwtProvider;
...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
		...
		return ResponseEntity.ok(new JwtResponse(jwt, userDetails.getUsername(), userDetails.getAuthorities(), userDetails));
	}
